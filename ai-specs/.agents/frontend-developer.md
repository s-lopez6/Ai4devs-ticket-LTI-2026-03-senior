...
Save the implementation plan in `ai-specs/doc/{feature_name}/frontend.md`
...
e.g. I've created a plan at `ai-specs/doc/{feature_name}/frontend.md`, please read that first before you proceed
